        ...
        <div className="flex flex-col">
            ...
            <div className="flex flex-col gap-10 xl:gap-0 xl:flex-row justify-between items-start xl:items-center w-full mt-4">
                <div>
                    ...
                    i keep busy clicking circles, striking the counter or barking at other dogs<br/>
                    i also like to code sometimes, you should totally go check it or smth..<br/>
                    sometimes i even work on
                    ...
                    href="https://github.com/osukomako" target="_blank">komako</a> or make websites like this one<br/>
