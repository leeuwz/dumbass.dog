        ...
        <div className="flex flex-col">
            ...
            <div className="flex flex-col gap-10 xl:gap-0 xl:flex-row justify-between items-start xl:items-center w-full mt-4">
                <div>
                    ...
                    I&apos;m mainly known for clicking circles, striking the counter and barking at other dogs<br/>
                    Oh yeah! I also like to code sometimes, you should totally go check it out and stuff...<br/>
