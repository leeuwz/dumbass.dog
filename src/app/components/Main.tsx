...
export default function Main() {
    return (
        <div className="flex flex-col">
            <div>
                <p className="text-4xl font-bold font-[family-name:var(--font-unbounded)]">hii chat 👋</p>
            </div>
            <div className="flex flex-col gap-10 xl:gap-0 xl:flex-row justify-between items-start xl:items-center w-full mt-4">
                <div>
                    <p className="text-xl font-[family-name:var(--font-sour-gummy)]">
                        ...
                        i keep busy run escaping, striking the counter or barking at other dogs<br />
                        i also like to code sometimes, you should totally go check it out..<br />
                        on rare occasions i even work on
                        ...
                        before:bg-[#f97af8] before:transition-all before:duration-300 hover:before:w-full hover:before:z-[-1]"
                            href="https://github.com/osukomako" target="_blank">
                            komako
                        </a>
                        {" "}or make websites like this one
                    </p>
                </div>
                <Discord />
            </div>
